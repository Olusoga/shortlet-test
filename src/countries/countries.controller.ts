...
export class CountriesController {
  ...
  @ApiQuery({ name: 'limit', required: false, description: 'Number of items per page', schema: { default: 10 } })
  ...
  @ApiParam({ name: 'name', required: true, description: 'Name of the country' })
  @ApiResponse({ status: 200, description: 'Details of the country', type: CountryDetailsDto })
